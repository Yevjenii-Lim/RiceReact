...
class CartPage extends React.Component {
  ...
  render () {
        ...
        <div key={index} className={s.order}>
          ...
          <div className={s.title}>
            ...
            <div className={s.btns}>
              <button className={s.sBtn} onClick={() => this.props.removeAmount(i.id)}>
                <svg
              ...
              <span>{i.amount}</span>
              <button className={s.sBtn} onClick={() => this.props.addAmount(i.id)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="24"
    ...
    sum += (+this.props.cart.extraVas + +this.props.cart.extraSoy + +this.props.cart.extraImbir) * 15
    ...
    return (
      ...
      <div className={s.sticks}>
        ...
        ></input>
        <p className={s.extraTitle} onClick={this.props.openExtra}>Дополнительно - 15грн порция
        <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
        ...
        <div className={s.delivery}>
            ...
            <input type="text" name="" id="name" onChange={(e) => this.props.changeName(e.target.value)} value={this.props.cart.name} placeholder="Ваше имя"/>
            <input type="text" name="" id="number" onChange={(e) => this.props.changeNumber(e.target.value)} value={this.props.cart.number} placeholder="Ваш номер телефона"/>
            <input type="text" name="" id="adres" onChange={(e) => this.props.changeAdres(e.target.value)} value={this.props.cart.adres} placeholder="Адрес"/>
        </div>
      </div>
      <div className={s.total}>
        ...
        <div>
          <button onClick={() => this.props.sendOrederThunkCreator(this.props.cart,sum)}>
            Заказать
          </button>
        </div>
      </div>
